// Code generated by "enumer -type=WalletEventType,TransferStatus -transform=snake -output=wallet_enum.go -json -sql -text"; DO NOT EDIT.
...
const _WalletEventTypeName = "event_type_invalidevent_type_debit_transferevent_type_credit_transferevent_type_update_transfer_status"

var _WalletEventTypeIndex = [...]uint8{0, 18, 43, 69, 102}

const _WalletEventTypeLowerName = "event_type_invalidevent_type_debit_transferevent_type_credit_transferevent_type_update_transfer_status"
...
var _WalletEventTypeNameToValueMap = map[string]WalletEventType{
	_WalletEventTypeName[0:18]:        EventTypeInvalid,
	_WalletEventTypeLowerName[0:18]:   EventTypeInvalid,
	_WalletEventTypeName[18:43]:       EventTypeDebitTransfer,
	_WalletEventTypeLowerName[18:43]:  EventTypeDebitTransfer,
	_WalletEventTypeName[43:69]:       EventTypeCreditTransfer,
	_WalletEventTypeLowerName[43:69]:  EventTypeCreditTransfer,
	_WalletEventTypeName[69:102]:      EventTypeUpdateTransferStatus,
	_WalletEventTypeLowerName[69:102]: EventTypeUpdateTransferStatus,
}

var _WalletEventTypeNames = []string{
	_WalletEventTypeName[0:18],
	_WalletEventTypeName[18:43],
	_WalletEventTypeName[43:69],
	_WalletEventTypeName[69:102],
}
...
const _TransferStatusName = "transfer_status_invalidtransfer_status_pendingtransfer_status_completedtransfer_status_failed"

var _TransferStatusIndex = [...]uint8{0, 23, 46, 71, 93}

const _TransferStatusLowerName = "transfer_status_invalidtransfer_status_pendingtransfer_status_completedtransfer_status_failed"
...
var _TransferStatusNameToValueMap = map[string]TransferStatus{
	_TransferStatusName[0:23]:       TransferStatusInvalid,
	_TransferStatusLowerName[0:23]:  TransferStatusInvalid,
	_TransferStatusName[23:46]:      TransferStatusPending,
	_TransferStatusLowerName[23:46]: TransferStatusPending,
	_TransferStatusName[46:71]:      TransferStatusCompleted,
	_TransferStatusLowerName[46:71]: TransferStatusCompleted,
	_TransferStatusName[71:93]:      TransferStatusFailed,
	_TransferStatusLowerName[71:93]: TransferStatusFailed,
}

var _TransferStatusNames = []string{
	_TransferStatusName[0:23],
	_TransferStatusName[23:46],
	_TransferStatusName[46:71],
	_TransferStatusName[71:93],
}
